...
public final class KotlinJvmTestBuilder extends KotlinAbstractTestBuilder<JvmCompilationTask> {
  ...
  void setupForNext(CompilationTaskInfo.Builder taskInfo) {
    ...
    taskBuilder
        ...
        .setGeneratedJavaSources(
            directory(DirectoryType.JAVA_SOURCE_GEN).toAbsolutePath().toString())
        .setGeneratedStubClasses(
            directory(DirectoryType.GENERATED_STUBS).toAbsolutePath().toString())
        ...
        .setCoverageMetadataClasses(
            directory(DirectoryType.COVERAGE_METADATA).toAbsolutePath().toString());
  }
  ...
  public class TaskBuilder {
    ...
    public TaskBuilder outputJavaJdeps() {
      taskBuilder.getOutputsBuilder()
          .setJavaJdeps(
              instanceRoot().resolve("java_jdeps_file.jdeps").toAbsolutePath().toString());
      return this;
    }
    ...
    public TaskBuilder generatedSourceJar() {
      taskBuilder.getOutputsBuilder()
          .setGeneratedJavaSrcJar(
              instanceRoot().resolve("gen-src.jar").toAbsolutePath().toString());
      return this;
    }

    public TaskBuilder ktStubsJar() {
      taskBuilder.getOutputsBuilder()
          .setGeneratedJavaStubJar(
              instanceRoot().resolve("kt-stubs.jar").toAbsolutePath().toString());
      return this;
    }
    ...
    public TaskBuilder incrementalData() {
      taskBuilder.getOutputsBuilder()
          .setGeneratedClassJar(
              instanceRoot().resolve("incremental.jar").toAbsolutePath().toString());
      return this;
    }
  }
}
